...
<template>
	<div
		...
		<header class="max-w-7xl mx-auto mb-16 text-center pt-10">
			...
			<Typography variant="body" class="text-text-secondary text-xl">Design System for Goranee.ir</Typography>
		</header>
		...
		<main class="max-w-7xl mx-auto space-y-20">
			...
			<section>
				...
				<div class="grid grid-cols-2 md:grid-cols-4 gap-6">
					<div class="flex flex-col gap-2">
						<div class="w-full h-24 rounded-2xl shadow-sm border border-border-subtle bg-surface-base">
						</div>
						<div>
							<p class="font-bold text-sm text-text-primary">Canvas Background</p>
							<p class="text-xs font-mono text-text-secondary">{{ isDark ? '#130a12' : '#FDF2F0' }}</p>
						</div>
					</div>
					<div class="flex flex-col gap-2">
						<div class="w-full h-24 rounded-2xl shadow-sm border border-border-subtle bg-text-primary">
						</div>
						<div>
							<p class="font-bold text-sm text-text-primary">Primary Text</p>
							<p class="text-xs font-mono text-text-secondary">{{ isDark ? '#eddeeb' : '#2A1B28' }}</p>
						</div>
					</div>
					<div class="flex flex-col gap-2">
						<div class="w-full h-24 rounded-2xl shadow-sm border border-border-subtle bg-surface-card">
						</div>
						<div>
							<p class="font-bold text-sm text-text-primary">Card Surface</p>
							<p class="text-xs font-mono text-text-secondary">{{ isDark ? '#1f121d' : '#FFFFFF' }}</p>
						</div>
					</div>
					<div class="flex flex-col gap-2">
						<div class="w-full h-24 rounded-2xl shadow-sm border border-border-subtle bg-grad-primary">
						</div>
						<div>
			...
			<section>
				<div class="mb-8 border-b border-border-subtle pb-4 mt-12 transition-colors duration-300">
					...
					<Typography variant="body" class="text-text-secondary mt-1">Headings in Sans-Serif, Chords in
				...
				<div
					...
					<div class="space-y-6">
						...
						<div>
							...
							<Typography variant="body" class="text-text-secondary">
								Goranee is a community-driven platform. Access thousands of Kurdish chords, lyrics, and
								rhythms.
					...
					<div class="rounded-2xl p-6 border bg-surface-base border-border-subtle">
						<span class="text-xs text-pink-500 font-bold uppercase mb-4 block">Chord Sheet Preview</span>
			...
			<section>
				<div class="mb-8 border-b border-border-subtle pb-4 mt-12 transition-colors duration-300">
					<Typography variant="h2" class="font-black tracking-tight">03. Buttons & Interactions</Typography>
					<Typography variant="body" class="text-text-secondary mt-1">Gradient primaries, ghost secondaries.
					</Typography>
				</div>
				<div
					...
					<div class="flex flex-wrap items-center gap-6">
						...
						<!-- Tags/Chips -->
						<span
							class="px-3 py-1 rounded-md text-xs font-bold border bg-surface-base border-border-subtle text-text-secondary">Key:
							Am</span>
						<span
							class="px-3 py-1 rounded-md bg-pink-500/10 text-xs font-bold text-pink-500 border border-pink-500/20">Rhythm:
							7/8</span>
					</div>
			...
			<section>
				<div class="mb-8 border-b border-border-subtle pb-4 mt-12 transition-colors duration-300">
					...
					<Typography variant="body" class="text-text-secondary mt-1">Sticky 'Glassmorphism' Header.
					</Typography>
				</div>
			...
			<section>
				<div class="mb-8 border-b border-border-subtle pb-4 mt-12 transition-colors duration-300">
					<Typography variant="h2" class="font-black tracking-tight">06. The Musician's Toolbox</Typography>
					<Typography variant="body" class="text-text-secondary mt-1">Sticky controls for the Chord View page.
					</Typography>
				</div>
				<div
			...
			<section>
				<div class="mb-8 border-b border-border-subtle pb-4 mt-12 transition-colors duration-300">
					<Typography variant="h2" class="font-black tracking-tight">07. Marketing Blocks</Typography>
					<Typography variant="body" class="text-text-secondary mt-1">Call to Action & Footer.</Typography>
				</div>
				...
				<div
					...
					<div class="relative z-10 max-w-2xl">
						...
						<Button variant="secondary" class="bg-white text-pink-600 border-transparent hover:bg-pink-50">
							Create Free Account
							<ArrowRight class="w-4 h-4 ml-2" />
						</Button>
					</div>
					<!-- Decor -->
					<div class="absolute top-0 left-0 w-64 h-64 bg-white/10 rounded-full -ml-20 -mt-20 blur-2xl"></div>
					<div
