...
import { ref } from 'vue';
import { Search, Menu, User } from 'lucide-vue-next';
...
<template>
  <nav
    ...
    <div class="flex items-center gap-2">
      <div class="w-8 h-8 rounded-full bg-grad-primary flex items-center justify-center text-white font-bold shadow-lg">
        G</div>
