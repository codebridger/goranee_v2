...
const classes = computed(() => {
  ...
  const variants = {
    neutral:
      'bg-gray-100 dark:bg-white/10 text-gray-600 dark:text-gray-300 border-gray-200 dark:border-white/5',
  ...
  return `${base} ${variants[props.variant || 'neutral']} ${sizes[props.size || 'md']}`
})
</script>
